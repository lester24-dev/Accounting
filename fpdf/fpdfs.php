...
function Header()
{
	...
	$this->Cell(300,20,'Republic of the Philippines','0','1','C');
	$this->Ln(-14);
	$this->SetFont('Arial','B',15);
	// $this->Image('image_header/header.jpg',85,15,19,21);
	$this->Cell(300,20,'GCM ACCOUNTING FIRM','0','1','C');
	$this->Ln(-14);
	$this->SetFont('Arial','I',11);
	$this->Cell(300,20,'St. Joseph Village 7, Brgy. Marinig, Cabuyao, Laguna','0','1','C');
	$this->Ln(10);
}
