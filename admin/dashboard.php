...
$ref_journal = $dbh->query("SELECT * FROM journal");
$ref_journal_row = $ref_journal->rowCount();

$ref_ledger = $dbh->query("SELECT * FROM ledger");
$ref_ledger_row = $ref_ledger->rowCount();

$ref_trial = $dbh->query("SELECT * FROM trial ");
$ref_trial_row = $ref_trial->rowCount();

$pending_ref_journal = $dbh->query("SELECT * FROM journal WHERE status = 'Pending'");
$pending_journal = $pending_ref_journal->rowCount();

$pending_ref_cash = $dbh->query("SELECT * FROM `cash-flow-statement` WHERE status = 'Pending'");
                  ...
                  <div class="card" style="height:22vmax;overflow-y: auto;">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $approved_ref_journal = $dbh->query("SELECT * FROM journal WHERE dates = '".date("Y-m-d")."'");
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $journals = $dbh->query("SELECT * FROM journal");
                          $journal = $journals->rowCount();
                          ...
                          <?php }else{
                            ...
                            foreach($journals->fetchAll(PDO::FETCH_ASSOC) as $fetch){
                          ?>
                          <div class="d-flex pb-3 border-bottom justify-content-between">
                            <div class="mr-3"><i class="mdi mdi-signal-cellular-outline icon-md"></i></div>
                            <div class="font-weight-bold mr-sm-4">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="text-dark">
                          ...
                          $journal = $dbh->query("SELECT * FROM journal WHERE dates BETWEEN '$startDate' AND '$endDate'");
                  ...
                  <div class="card" style="height:22vmax;overflow-y: auto;">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $ledger = $dbh->query("SELECT * FROM ledger WHERE dates = '".date('Y-m-d')."'");
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $ledger = $dbh->query("SELECT * FROM ledger ");
                          $request = $ledger->rowCount();
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="text-dark">
                          <?php 
                         $journal = $dbh->query("SELECT * FROM ledger WHERE dates BETWEEN '$startDate' AND '$endDate'");
                         $request = $journal->rowCount();
                  ...
                  <div class="card" style="height:22vmax;overflow-y: auto;">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $trial = $dbh->query("SELECT * FROM trial WHERE dates = '".date("Y-m-d")."'");
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="text-dark">
                          ...
                          $trial = $dbh->query("SELECT * FROM trial ");
                          $request = $trial->rowCount();
                            if ($request === 0) {
                          ?>
                          <div class="d-flex pb-3 border-bottom justify-content-between">
