                ...
                <div class="card-body">
                 <?php 
                  ...
                  <div class="table-responsive">
                    ...
                    <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $item['data_id']; ?>">Delete</button>
                    </td>
                    </tr>
                    ...
                    <div class="modal fade" id="supplyModal<?php echo $item['data_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <button type="submit" class="btn btn-primary" name="update_transaction_data_admin">Update</button>
                                </div>
                                </form>
                            </div>
                            </div>
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $fetch['transaction_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-danger" name="delete_transaction_data_admin">Delete</button>
                                </div>
                                </form>
                            </div>
                            </div>
             ...
             <form action="../db/firebaseDB" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="text" class="form-control" id="first1" name="first[]" placeholder="1st Quarter">
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="second1" name="second[]" placeholder="2nd Quarter">
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="third1" name="third[]" placeholder="3rd Quarter">
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="fourth1" name="fourth[]" placeholder="4th Quarter">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="create_request_admin_data">Add</button>
                 </div>
             </form>
        </div>
         </div>
...
<script>
         document.addEventListener("DOMContentLoaded", function() {
            const input = document.getElementById('first');
             ...
             const input4 = document.getElementById('fourth');
...
<script>
         document.addEventListener("DOMContentLoaded", function() {
            const input = document.getElementById('first1');
             const input2 = document.getElementById('second1');
             const input3 = document.getElementById('third1');
             const input4 = document.getElementById('fourth1');
