...
$ref_journal = $dbh->query("SELECT * FROM journal WHERE customer_id = '".$_SESSION['id']."'");
$ref_journal_row = $ref_journal->rowCount();

$ref_ledger = $dbh->query("SELECT * FROM ledger WHERE customer_id = '".$_SESSION['id']."'");
$ref_ledger_row = $ref_ledger->rowCount();

$ref_trial = $dbh->query("SELECT * FROM trial WHERE customer_id = '".$_SESSION['id']."'");
$ref_trial_row = $ref_trial->rowCount();

$pending_ref_journal = $dbh->query("SELECT * FROM journal WHERE customer_id = '".$_SESSION['id']."' AND status = 'Pending'");
$pending_journal = $pending_ref_journal->rowCount();

$pending_ref_cash = $dbh->query("SELECT * FROM `cash-flow-statement` WHERE customer_id = '".$_SESSION['id']."' AND status = 'Pending'");
