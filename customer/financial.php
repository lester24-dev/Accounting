    ...
    <div class="col-lg-16 grid-margin stretch-card">
              <div class="card shadow mb-4">
                <div class="card-body">
                  ...
                  <a href="financial_pdf" class="btn btn-danger">PDF</a>
                  ...
                  <div class="table-responsive">
                    <table class="table" id="request" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <?php
                          $stmt = $dbh->query("SELECT * FROM `financial-statement`");
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="financial_statement_data?transaction_id=<?php echo $fetch['transaction_id']; ?>&customer_id=<?php echo $row_depts['id'] ?>"><i class="fa-solid fa-link" style="font-size:30px;"></i> </a>    
                        </td>
                        </tr>
