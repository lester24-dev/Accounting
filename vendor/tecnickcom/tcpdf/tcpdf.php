...
class TCPDF {
	...
	public function Header() {
		$this->Cell(200,20,'Republic of the Philippines','0','1','C');
		$this->Ln(-14);
		// $this->Image('image_header/header.jpg',33,15,19,21);
		$this->Cell(200,20,'GCM ACCOUNTING FIRM','0','1','C');
		$this->Ln(-14);
		$this->Cell(200,20,'St. Joseph Village 7, Brgy. Marinig, Cabuyao, Laguna','0','1','C');
		$this->Ln(10);
	}
	 ...
	 */
	  ...
	  public function setFooterDetails($approvedBy, $createdBy) {
        $this->approvedBy = $approvedBy;
        $this->createdBy = $createdBy;
    }

	public function Footer() {
		$this->SetY(-30); // Adjust height to fit multi-line footer

        // Set font for the footer
        $this->SetFont('helvetica', 'I', 13);

        // Add "Approved by" and "Created by" information
        $this->SetY(-20); // Adjust position for extra lines
        $this->Cell(0, 10, 'Approved by: ' . $this->approvedBy, 0, false, 'L', 0, '', 0, false, 'T', 'M');
        $this->SetY(-15);
        $this->Cell(0, 10, 'Created by: ' . $this->createdBy, 0, false, 'L', 0, '', 0, false, 'T', 'M');
	}
