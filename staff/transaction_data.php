              ...
              <div class="card shadow mb-4">
                ...
                <?php 
                  ...
                  <div class="table-responsive">
                    ...
                    <td><?php echo '&#8369;'.$item['third']; ?></td>
                    <td><?php echo '&#8369;'.$item['fourth']; ?></td>
                    <td>
                        <?php 
                        $characters = array(',', '.', ' ');
                    ...
                    <div class="modal fade" id="supplyModal<?php echo $item['data_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <button type="submit" class="btn btn-primary" name="update_transaction_data">Update</button>
                                </div>
                                </form>
                            </div>
                            </div>
         ...
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
             <form action="../db/firebaseDB" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="create_request_staff_data">Add</button>
                 </div>
             </form>
        </div>
         </div>
